...
<section class="relative overflow-hidden bg-[linear-gradient(135deg,#EAF4FB_0%,#F7FAFD_45%,#EDF5FB_100%)] py-16 sm:py-20 lg:py-24" id="faq">
  <div class="container w-full max-w-3xl mx-auto px-6 sm:px-10">

    <h2 class="text-center text-hp-dark text-3xl sm:text-4xl lg:text-[2.5rem] font-bold tracking-tight mb-10 lg:mb-14" data-reveal="up" data-reveal-delay="0">
      Common Questions
    </h2>
    ...
    <div class="space-y-4">
      ...
      <details class="group bg-white rounded-2xl shadow-[0_4px_16px_rgba(16,24,40,0.06)]" data-reveal="up" data-reveal-delay="60">
        <summary class="flex items-center justify-between gap-4 cursor-pointer list-none px-6 sm:px-7 py-4 sm:py-5 [&::-webkit-details-marker]:hidden">
          <span class="text-hp-dark text-sm sm:text-[15px] font-semibold">Can HealthInPocket work with our existing hospital software?</span>
        ...
        <p class="px-6 sm:px-7 pb-5 -mt-1 text-hp-muted text-sm leading-relaxed">
          Yes. HealthInPocket integrates seamlessly with your existing HMS, EMR, and lab systems through secure APIs, so you can adopt the platform without disrupting your current operations.
        </p>
      </details>

      <details class="group bg-white rounded-2xl shadow-[0_4px_16px_rgba(16,24,40,0.06)]" data-reveal="up" data-reveal-delay="120">
        <summary class="flex items-center justify-between gap-4 cursor-pointer list-none px-6 sm:px-7 py-4 sm:py-5 [&::-webkit-details-marker]:hidden">
          <span class="text-hp-dark text-sm sm:text-[15px] font-semibold">Can we launch HealthInPocket under our hospital's brand?</span>
          <svg class="w-4 h-4 text-hp-dark shrink-0 transition-transform duration-200 group-open:rotate-45" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.75" aria-hidden="true">
            <path d="M8 3v10M3 8h10" stroke-linecap="round"/>
          </svg>
        </summary>
        <p class="px-6 sm:px-7 pb-5 -mt-1 text-hp-muted text-sm leading-relaxed">
          Absolutely. Our white-label solution lets you launch your own branded patient app, portal, and digital ecosystem under your hospital's identity, with your logo, colors, and domain.
        </p>
      </details>

      <details class="group bg-white rounded-2xl shadow-[0_4px_16px_rgba(16,24,40,0.06)]" data-reveal="up" data-reveal-delay="180">
        <summary class="flex items-center justify-between gap-4 cursor-pointer list-none px-6 sm:px-7 py-4 sm:py-5 [&::-webkit-details-marker]:hidden">
          <span class="text-hp-dark text-sm sm:text-[15px] font-semibold">Is HealthInPocket suitable for hospitals of all sizes?</span>
          <svg class="w-4 h-4 text-hp-dark shrink-0 transition-transform duration-200 group-open:rotate-45" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.75" aria-hidden="true">
            <path d="M8 3v10M3 8h10" stroke-linecap="round"/>
          </svg>
        </summary>
        <p class="px-6 sm:px-7 pb-5 -mt-1 text-hp-muted text-sm leading-relaxed">
          Yes. From single-speciality clinics to multi-branch hospital networks, the platform scales with you — with unified dashboards, centralized reporting, and per-branch management built in.
        </p>
      </details>

      <details class="group bg-white rounded-2xl shadow-[0_4px_16px_rgba(16,24,40,0.06)]" data-reveal="up" data-reveal-delay="240">
        <summary class="flex items-center justify-between gap-4 cursor-pointer list-none px-6 sm:px-7 py-4 sm:py-5 [&::-webkit-details-marker]:hidden">
          <span class="text-hp-dark text-sm sm:text-[15px] font-semibold">How secure is patient data on HealthInPocket?</span>
          <svg class="w-4 h-4 text-hp-dark shrink-0 transition-transform duration-200 group-open:rotate-45" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.75" aria-hidden="true">
            <path d="M8 3v10M3 8h10" stroke-linecap="round"/>
          </svg>
        </summary>
        <p class="px-6 sm:px-7 pb-5 -mt-1 text-hp-muted text-sm leading-relaxed">
          Patient data is protected with end-to-end encryption, role-based access controls, audit logs, and secure authentication on compliance-ready infrastructure.
        </p>
      </details>
